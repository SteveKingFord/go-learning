...
func GetItemList(c *gin.Context) {
	var listService category.ListItemService
...
func GetItem(c *gin.Context) {
	deleteService := category.GetItemService{}
...
// @Param collection body category.CreateItemService true "创建信息"
// @success 200 {object} global.Response "成功"
// @Failure 400 {object}  global.Response "失败"
// @Router /api/collection-category [post]
func CreateItem(c *gin.Context) {
	var createService category.CreateItemService
...
// @Accept application/json
// @Param id path string true "主键id"
// @Param collection body category.UpdateItemService true "修改信息"
// @success 200 {object} global.Response "成功"
// @Failure 400 {object}  global.Response "失败"
...
func DeleteItem(c *gin.Context) {
	deleteService := category.DeleteItemService{}
